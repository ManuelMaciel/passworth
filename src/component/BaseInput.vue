...
.input {
  ...
  &:not(.input--focus) {
    &:hover,
    &:focus {
      box-shadow: 0 0.75rem 2rem -1.1rem rgba(2, 202, 162, 0.65);
      @media (prefers-color-scheme: dark) {
        box-shadow: 0 1rem 2rem -1.1rem rgba(2, 202, 162, 0.75);
      }
    }
  }
  &:not(.input--prefix) {
  ...
  &.input--focus {
    box-shadow: 0 1rem 2rem -1.1rem rgba(2, 202, 162, 0.75);
    @media (prefers-color-scheme: dark) {
      box-shadow: 0 1rem 2rem -1.1rem rgba(2, 202, 162, 0.85);
    }
    .input__field {
